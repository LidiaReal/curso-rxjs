...
(() =>{
    ...
    getRequest(`${SW_API}/people/2`).pipe( // USO EL 2 QUE ES C3PO PORQUE EL DE LUKE ESTA VACIO EL ARRAY SPECIES
        // Realizar los operadores respectivos aquí
        // PRIMER EJERCICIO: switchMap( resp => getRequest( resp.species[0]))
